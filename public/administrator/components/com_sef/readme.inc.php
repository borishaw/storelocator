...
<div class="docs">
    <p style="text-align: right;"><span class="small">Updated: August 24, 2007</span></p>
    <h1>sh404SEF Documentation</h1>
    <p style="text-align: center;">for Joomla 1.0.x</p>
    <h2>Support site</h2>
    <br />
    You will find up to date information and support at <a href="http://extensions.siliana.net/en/">extensions.Siliana.net/en/</a>. Please also check our forum at <a href="http://extensions.siliana.net/forum/">extensions.Siliana.net/forum/</a>. Please read also our Frequently Asked Question, probably the best place to start with if something does not work as you like<br /><br />
    <h2>Summary</h2>
    <p><span class=h5>Allows Search Engine Friendly URLs for Apache</strong> (and possibly but unsupported, IIS). You can also setup your own, custom URLs if you don't like those automatically built. Builds page title and meta tags, and insert them into page. Title and tags can be manually set as well. Provides security functions, by checking the content of URL and visitor IP against various security check lists, plus an anti-flooding system.</p>
        <p>sh404SEF works well with <span class=h5>Joomfish</span>, and there are several plugins to build up URL for various components, including <span class=h5>Virtuemart, Fireboard, Community Builder, Myblog, iJoomla Magazine and NewsPortal, Mosets Tree and Hot Property,...</span>. If you use Joomfish, please take a look at the bottom of this document for a Joomfish fix to allow translation of content element Alias. If you use Virtuemart, please read the special note at the end of this document, where you will find a couple of fixes for Virtuemart 1.0.10 : one to work with Joomfish (comes from the Virtuemart forum), the other to allow smooth operation when using SSL mode (comes from <a href="http://www.netshinesoftware.com">NetshineSoftware</a>).</p>
        <p>It has a caching system, to reduce database queries and enhance page loading time when using URL rewriting.</p>
        <p>sh404SEF can  operate <span class=h5>with or without mod_rewrite</span> (that is with or without .htaccess file). Url are the same, except there is an added /index.php/ bit in them when not using .htaccess. This is now the default setting, as it is much easier to use. You may want to adjust your ErrorDocument as 404 errors will no longer be processed by Joomla when operating without a .htaccess file.</p>
        <p>The integrated tool to manage your META tags, <span class=h5>shCustomTags</span> is a module that will rewrite Title, Description, Keywords, Robots and Language meta tags to your liking, on any page of your site. It has a plugin system to accomodate any component, and a Virtuemart and a regular content plugin are provided to automatically generate these tags. Plus, you'll be able to manually set any tags you like on a page by page basis (a page is identified by its URL). Plus you'll be able to set content title within h1 tags, and remove Generator = Joomla tags, plus perform various text replacement operations on your page.</p>
        <p>There is no hack of Joomla, just a module. shCustomTags has been installed automatically with sh404SEF, but it not published initially. You must publish it and review instructions in its backend. </p>
        <p>Both sh404SEF and shCustomTags have been tested only using Joomla 1.012 and VirtueMart 1.0.10 (should work with previous version of Joomla - don't know about previous versions of VirtueMart). Simple tests ahve been done with Joomla 1.0.13, so sh404SEF should not cause any problem there.</p>
        <p>Many thanks to all previous contributors to 404SEF and 404SEFx</p>
 <h2>Documentation</h2>
 
 <p><h4>IMPORTANT : if you plan to use mod_rewrite (.htaccess) rewriting : </h4> <span class=h5>BEFORE</span> making any attempt to activate this component and use its URL rewriting functions, <span class=h5>your Joomla installation should already be compatible with URL rewriting</span>. This is not required if you select no .htaccess rewrite mode in sh404SEF advanced parameters (but this mode may not always work as well, depending on your server settings). <br /><br />Remember : if you are having difficulties with this, it is unlikely to be a joomla problem, but most likely something related to your server setup. For instance, many times, you will be faced with 404 errors or Internal server errors 500 display. This indicates that there is something in your .htacces file that is not compatible with your apache server setup.<br /><br />
...
<p>More advice on .htaccess, a very tricky issue on many occasions, can be found on line at <a><http://extensions.siliana.net/en/Table/sh404SEF-and-url-rewriting//a>. In a few words :</p>
<ul>
...
<br />
                ...
                <li>
                    ...
                    <ul id="iis" style="list-style: none">
                        <li> <span class=h5>IMPORTANT</span> : The instructions below are provided as is, with no warranty. They are simply copied over from past version of 404SEFx, and I have absolutely no idea if they are correct or not. Any feed back on that matter is appreciated, and may passed over to other people using the support forum at <a href="http://extensions.siliana.net/forum/">extensions.Siliana.net/forum/</a>. Please not that good results have been reported using the "no .htaccess (/index.php/)" operating mode of sh404SEF instead of trying to setup a rewriting engine in IIS. If you use this operating mode, you don"t need anything than just sh404SEF. However, again, IIS may have been configured in a way where even this mode cannot work, so please report to sh404SEF support forum, or to Joomla Forum for assistance in setting this up.<br />
                    <br />
                            <ol>
                                <li>
        ...
        <li>
            ...
            <p>You can import and export your URL to a text file, using the corresponding button on sh404SEF control panel.</p>
...
<br />
    ...
    <div class="small" style="text-align: center;">
        Copyright &copy; 2004-2007 Yannick Gaultier<br />
