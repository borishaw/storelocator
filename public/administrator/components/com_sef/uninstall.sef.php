 ...
 * @package     sh404SEF
 * @version     $Id: uninstall.sef.php 24 2007-09-19 18:35:29Z silianacom-svn $
...
function com_uninstall() {
  ...
  echo '<br />';
	if ($sefConfig->shKeepCustomURLOnUpgrade)
	  echo '- custom SEF url have not been deleted (table #__redirection)<br />';
	else 
    echo '- custom SEF url have been deleted<br />';  
  echo '<br />';
	if ($sefConfig->shKeepMetaDataOnUpgrade)
