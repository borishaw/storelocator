...
define('_COM_SEF_DISABLED',"<p class='error'>NOTA: Il supporto SEF in Joomla/Mambo &egrave; attualmente disabilitato. Per usare SEF, attivalo da <a href='".$GLOBALS['mosConfig_live_site']."/administrator/index2.php?option=com_config'>Configurazione Globale</a> pagina SEO.</p>");
...
define('_COM_SEF_SH_CONF_META_DOC', 'ATTENZIONE : per attivare la gestione dei tag di Titolo, Descrizione, Keywords, Robots e linguaggio, <strong>devi pubblicare il modulo shCustomTags</strong>, che &egrave; stato automaticamente installato insieme a sh404SEF. La <strong>posizione</strong> nella quale pubblicherai questo modulo avr&agrave; molta importanza per un corretto funzionamento. Per favore, attieniti alla docmentazione propria del modulo, mostrata nei parametri del backend. <br/>sh404SEF ha numerosi plugins per creare META tags per diversi componenti<strong>automaticamente</strong>. Non li creare manualmente fino a che quelli creati automaticamente non ti soddisfino!!<br>');
define('_COM_SEF_SH_REMOVE_JOOMLA_GENERATOR', 'Rimuovi Joomla Generator tag');
define('_COM_SEF_TT_SH_REMOVE_JOOMLA_GENERATOR', 'Se impostato su <strong>Si</strong>, il Generator = Joomla meta tag sar&agrave; rimosso da ogni pagina dove &egrave; pubblicato il modulo shCustomTags');
