...
define('_COM_SEF_DISABLED',"<p class='error'>NOTA: Soporte para SEF en Joomla/Mambo está actualmente desabilitado. Para usar SEF, hablítelo desde la<a href='".$GLOBALS['mosConfig_live_site']."/administrator/index2.php?option=com_config'>Configuración Global</a> página SEO.</p>");
