...
define('_COM_SEF_ASC',' (Opl) ');
define('_COM_SEF_BACK','Terug naar sh404SEF Control Panel');
define('_COM_SEF_BADURL','De oude Non-SEF Url moet beginnen met index.php');
define('_COM_SEF_CHK_PERMS','Gelieve  de bestandsrechten na te zien en te zorgen dat het bestand leesbaar is.');
define('_COM_SEF_CONFIG','sh404SEF<br/>Configuratie');
define('_COM_SEF_CONFIG_DESC','Configureer alle sh404SEF functionaliteiten');
define('_COM_SEF_CONFIG_UPDATED','Configuratie geupdated');
define('_COM_SEF_CONFIRM_ERASE_CACHE', 'Wenst u de URL cache the wissen? Dit is sterk aanbevolen na het aanpassen van de configuratie. Om de cache opnieuw te genereren, bezoek uw homepagina of beter nog, uw sitemap.');
...
define('_COM_SEF_DEF_404_MSG','<h1>404: Niet gevonden</h1><h4>Sorry, maar de inhoud kon niet worden gevonden.</h4>');
define('_COM_SEF_DEF_404_PAGE','Standaard 404 Pagina');
define('_COM_SEF_DESC',' (Afl) ');
define('_COM_SEF_DISABLED',"<p class='error'>NOTE: SEF support in Joomla/Mambo is momenteel uitgeschakeld. Om SEF te gebruiken, activeer het via <a href='".$GLOBALS['mosConfig_live_site']."/administrator/index2.php?option=com_config'>Algemene Configuratie</a> SEO pagina.</p>");
define('_COM_SEF_EDIT','Aanpassen');
define('_COM_SEF_EMPTYURL','U moet een URL geven voor de verwijzing.');
define('_COM_SEF_ENABLED','Ingeschakeld');
define('_COM_SEF_ERROR_IMPORT','Fout bij het importeren:');
define('_COM_SEF_EXPORT','Backup Custom URLS');
define('_COM_SEF_EXPORT_FAILED','EXPORT MISLUKT!!!');
define('_COM_SEF_FATAL_ERROR_HEADERS','FATAL ERROR: HEADER ALREADY SENT');
define('_COM_SEF_FRIENDTRIM_CHAR','Trim vriendelijke karakters');
define('_COM_SEF_HELP','sh404SEF<br/>Support');
define('_COM_SEF_HELPDESC','Hulp nodig met sh404SEF?');
define('_COM_SEF_HELPVIA','<b>Help is beschikbaar via volgende forums:</b>');
define('_COM_SEF_HIDE_CAT','Category verbergen');
define('_COM_SEF_HITS','Hits');
define('_COM_SEF_IMPORT','Importeer Custom URLS');
define('_COM_SEF_IMPORT_EXPORT','Importeer/Exporteer URLS');
define('_COM_SEF_IMPORT_OK','Custom URLS succesvol geïmporteerd!');
define('_COM_SEF_INFO','sh404SEF<br/>Documentatie');
define('_COM_SEF_INFODESC','Bekijk sh404SEF Project samenvatting en Documentatie');
define('_COM_SEF_INSTALLED_VERS','Geïnstalleerde versie:');
...
define('_COM_SEF_LICENSE','Licensie');
define('_COM_SEF_LOWER','Alles kleine letters');
define('_COM_SEF_MAMBERS','Mambers Forum');
define('_COM_SEF_NEWURL','Oude Non-SEF Url');
define('_COM_SEF_NO_UNLINK','Niet mogelijk om het geuploade bestand te verwijderfen uit de media map');
define('_COM_SEF_NOACCESS','Toegang onmogelijk');
define('_COM_SEF_NOCACHE','nocache');
define('_COM_SEF_NOLEADSLASH','Er mag GEEN LEADING SLASH (schuine streep in het begin) zijn op de nieuwe SEF URL');
define('_COM_SEF_NOREAD','FATAL ERROR: Bestand lezen onmogelijk ');
define('_COM_SEF_NORECORDS','Geen records gevonden.');
define('_COM_SEF_OFFICIAL','Officieel Project Forum');
define('_COM_SEF_OK',' OK ');
define('_COM_SEF_OLDURL','Nieuwe SEF URL');
define('_COM_SEF_PAGEREP_CHAR','Page spacer character');
define('_COM_SEF_PAGETEXT','Pagina tekst');
define('_COM_SEF_PROCEED',' Doorgaan ');
...
define('_COM_SEF_SAVEAS','Bewaren als Custom Redirect');
define('_COM_SEF_SEFURL','SEF Url');
define('_COM_SEF_SELECT_DELETE','Selecteer een item om te wissen');
define('_COM_SEF_SELECT_FILE','Kies eerst een bestand');
define('_COM_SEF_SH_ACTIVATE_IJOOMLA_MAG', 'Activeer iJoomla magazine in content');
define('_COM_SEF_SH_ADV_INSERT_ISO', 'ISO code invoegen');
define('_COM_SEF_SH_ADV_MANAGE_URL', 'URL processing');
define('_COM_SEF_SH_ADV_TRANSLATE_URL', 'Vertaal URL');
define('_COM_SEF_SH_ALWAYS_INSERT_ITEMID', 'Itemid altijd toevoegen aan SEF URL');
define('_COM_SEF_SH_ALWAYS_INSERT_ITEMID_PREFIX', 'menu id');
define('_COM_SEF_SH_ALWAYS_INSERT_MENU_TITLE', 'Menu title altijd toevoegen');
