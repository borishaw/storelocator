...
define('_COM_SEF_DISABLED',"<p class='error'>ПРИМЕЧАНИЕ: Поддержка SEF в Joomla/Mambo выключена. Для использования SEF, пожалуйста, включите ее из страницы SEO<a href='".$GLOBALS['mosConfig_live_site']."/administrator/index2.php?option=com_config'>Глобальная Конфигурация</a></p>");
...
define('_COM_SEF_SH_CONF_META_DOC', '<font color="#C00020"><strong>ВНИМАНИЕ</strong></font>: Для активации менеджмента тегов Title, Description, Keywords, Robots и Language,<br /><strong>Вам необходимо опубликовать модуль shCustomTags</strong>, который был автоматически установлен вместе с sh404SEF.<br /><strong>Позиция</strong>, в которой Вы опубликуете данный модуль, имеет <strong>очень</strong> важное значение для правильного функционирования. Пожалуйста, ознакомьтесь с документацией на данный модуль, которая выводится в параметрах его администрирования. <br/>sh404SEF имеет несколько плагинов для <strong>автоматического</strong> создания META тегов для некоторых компонентов. Не создавайте их вручную пока автоматически создаваемые не перестануть Вас удовлетворять!<br>');
define('_COM_SEF_SH_REMOVE_JOOMLA_GENERATOR', 'Убрать тег Joomla Generator');
define('_COM_SEF_TT_SH_REMOVE_JOOMLA_GENERATOR', 'Если <strong>Да</strong>, мета тег Generator = Joomla будет убираться со всех страниц, где опубликован модуль shCustomTags.');
...
define('_COM_SEF_TT_SH_LOG_ATTACKS', 'Если Да, идентифицированные атаки будут записаны в текстовый файл, который будет включать IP адрес атакующего и сделанный запрос страницы.<br />На один месяц один файл. Располагаются они в <root сайта>/administrator/com_sef/logs directory. Скачать их можно используя FTP или используя утилиту Joomla, например, как Joomla Explorer для их просмотра. В файле текст разделен TAB`ами, чтобы ваш текстовый процессор смог легче его открыть.');	            
