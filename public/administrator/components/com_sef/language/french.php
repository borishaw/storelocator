...
define('_COM_SEF_SH_CONF_META_DOC', 'ATTENTION : Pour activer la gestion des balises Titre, Description, Keywords, Robots et language, <strong>vous devez publier le module shCustomTags</strong>, qui a été installé automatiquement en même temps que sh404SEF. La <strong>position</strong> dans laquelle ce module est publié est importante pour son bon fonctionnement. Merci de vous référer à la documentation affichée dans les paramètres du module lui-même.<br/>sh404SEF est équipé de plugins pour la création <strong>automatique</strong> des balises META pour un certain nombre de composants. Ne les créez manuellement que si vous les valeurs calculées automatiquement ne vous satisfont pas!<br>');
define('_COM_SEF_SH_REMOVE_JOOMLA_GENERATOR', 'Supprimer Joomla Generator');
define('_COM_SEF_TT_SH_REMOVE_JOOMLA_GENERATOR', 'Si activé, balise meta Generator = Joomla sera supprimée des pages sur laquelle le module shCustomTags est publié');
