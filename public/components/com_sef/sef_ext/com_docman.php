 ...
 * shumisha@gmail.com
 * @version     $Id: com_docman.php 24 2007-09-19 18:35:29Z silianacom-svn $
...
if (!empty($gid) && (strpos($task,'doc_') !== false))
...
if (($sefConfig->shDocmanInsertDocName || (strpos($task,'doc_') === false)) && !empty($gid))
