...
//Version_1.3_RC - build_150 - Joomla - <a href="http://extensions.siliana.net/en/">extensions.Siliana.net/en/</a>		
if (!defined('_VALID_MOS')) die('Direct Access to this location is not allowed.');
$version = "Version_1.3_RC - build_150 - Joomla - <a href=\"http://extensions.siliana.net/en/\">extensions.Siliana.net/en/</a>";
$Enabled = "1";
$replacement = "-";
$pagerep = "-";
$stripthese = ",|~|!|@|%|^|(|)|<|>|:|;|{|}|[|]|&";
...
$shInsertGlobalItemidIfNone = true;
